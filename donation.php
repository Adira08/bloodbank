          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td><button type="button" class="primary_btn"><a href="donationreg.php?donationcamp=<?php echo $row['id']; ?>" style="color: white;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register</a></button></td>
