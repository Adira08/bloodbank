      ...
      <div class="donation-table">
        <div class="container">
          <?php
            ...
            $exec = mysqli_query($bloodbank,"SELECT * FROM donation_camp ORDER BY id DESC") or die(mysqli_error($bloodbank));
          ...
          ?>
          <table class="table">
            <h4 style="color: white; background-color: red; text-align: center;">Blood Donation Camps Schedule</h4>
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td><button type="button" class="primary_btn"><a href="donationreguser.php?donationcamp=<?php echo $row['id']; ?>" style="color: white;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Register</a></button></td>
